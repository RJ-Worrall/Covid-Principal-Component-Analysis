...
Future Improvements:
Currently, this program simple just performs the principal component analysis, and doesn't go any deeper into the data after that. Now that the data has been reduced down to the most impactful principal components, future analysis could involve visualizing relationships between components, exploring the most important variables from a statistical standpoint, and predicitng emotional responses using regression or other machine learning techniques.
